    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-white py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl md:text-5xl font-bold text-[#36596A] mb-6 leading-tight">
        ...
        <section className="bg-[#F9F9F9] py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h2 className="text-2xl md:text-3xl font-bold text-[#36596A] mb-6">
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-[#36596A] mb-6 text-center">
            "You Saved for Retirement… But Nobody Showed You How to Actually <em>Use</em> That Money, Did They?"
          </h2>
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>"Am I taking too much risk… or not enough?"</li>
              <li>"How do I make this money <em>last</em> — without giving up my lifestyle?"</li>
              <li>"What about taxes… Medicare premiums… RMDs… inflation?"</li>
            </ul>
            
            <p>You're not alone.</p>
            <p>Even people with <strong>$500,000… $750,000… even over a million dollars saved</strong> are worried about the same thing:</p>
            <p className="text-xl font-semibold">👉 "Do I have <em>enough</em> to retire and stay retired — for good?"</p>
            
            <h3 className="text-2xl font-bold text-[#36596A] mt-8 mb-4">📉 Retirement is More Confusing Now Than Ever Before</h3>
            <p>Gone are the days of guaranteed pensions.</p>
            <p>Interest rates are all over the place.</p>
            <p>Markets are unpredictable, Social Security is unclear, and the advice you're getting is…</p>
            ...
            <p>You're stuck in the middle — with <strong>real money on the line</strong>… and no clear answers.</p>
            
            <h3 className="text-2xl font-bold text-[#36596A] mt-8 mb-4">😔 The Truth?</h3>
            <p>Most people are better prepared to <em>get</em> to retirement&hellip; Than they are to <em>get through</em> retirement.</p>
            <p>And if you're feeling anxious, hesitant, or unsure about how to turn your savings into dependable income…</p>
      ...
      <section className="bg-white py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
            ...
            <h3 className="text-3xl font-bold text-[#36596A] mt-8 mb-4 text-center">✅ The Retirement Income Blueprint™</h3>
            <p className="text-xl font-semibold text-center mb-4">A straightforward, no-fluff system that helps you turn your nest egg into a reliable income stream — even if you're not a financial expert.</p>
            ...
            <h3 className="text-2xl font-bold text-[#36596A] mt-8 mb-4">✅ What Makes This Different?</h3>
            ...
            <p>It's about <strong>preserving it</strong>… and using it <strong>wisely</strong>.</p>
          </div>
        </div>
      </section>

      {/* Section 4: Establish Credibility */}
      <section className="bg-[#F9F9F9] py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
            ...
            <h3 className="text-2xl font-bold text-[#36596A] mt-8 mb-4">🧾 Built By People Who Actually Help Retirees — Not Sell Products</h3>
            <p>Unlike many so-called "financial educators" online…</p>
            ...
            <h3 className="text-2xl font-bold text-[#36596A] mt-8 mb-4">💬 What Others Are Saying</h3>
            <div className="bg-white rounded-lg p-6 mb-4 shadow-md">
              <p className="text-lg italic text-gray-700 mb-2">"This blueprint helped me stop second-guessing my entire plan. I now know exactly how much I can take each month and how to make it last — even with inflation."</p>
              <p className="text-sm text-gray-600">— <em>David S., 68, Retired Engineer</em></p>
            </div>
            <div className="bg-white rounded-lg p-6 mb-4 shadow-md">
              <p className="text-lg italic text-gray-700 mb-2">"I finally feel in control of my retirement income. For the first time in years, I'm not worrying about the market every day."</p>
              <p className="text-sm text-gray-600">— <em>Karen M., 63, Retired Nurse</em></p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <p className="text-lg italic text-gray-700 mb-2">"It's like a GPS for your money in retirement. Easy to follow, realistic, and extremely helpful."</p>
              <p className="text-sm text-gray-600">— <em>Paul & Jenny, 70 & 67, Empty Nesters</em></p>
            </div>
            
            <p className="mt-6">This system has now been downloaded by <strong>over 12,000 people</strong> — many of whom had the exact same concerns you do right now.</p>
            <p>The only difference is…</p>
            <p className="text-xl font-semibold">They took action.</p>
            <p className="text-xl font-semibold">You still can too.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <div className="space-y-6 mt-8">
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-bold text-[#36596A] mb-2">✅ Module 1: The Retirement Income Reset</h3>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-bold text-[#36596A] mb-2">✅ Module 2: The Income Floor Formula</h3>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-bold text-[#36596A] mb-2">✅ Module 3: The 3-Bucket Withdrawal Strategy</h3>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-bold text-[#36596A] mb-2">✅ Module 4: The Retirement Tax Gap</h3>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-bold text-[#36596A] mb-2">✅ Module 5: The Market-Proof Plan</h3>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-bold text-[#36596A] mb-2">✅ Module 6: The Confidence Calendar™</h3>
            ...
            <div className="bg-blue-50 rounded-lg p-6 mt-8">
              <h3 className="text-xl font-bold text-[#36596A] mb-4">📘 You'll Also Receive:</h3>
            ...
            <h3 className="text-2xl font-bold text-[#36596A] mt-8 mb-4">🧠 Bottom Line?</h3>
            <p>By the time you finish this program, you'll know:</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>And you'll have a real, working <strong>plan</strong> — not just "ideas."</p>
            <p>All for a one-time investment that's probably <strong>less than what you spent on lunch this week.</strong></p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
            <p className="text-xl font-semibold">Picture this…</p>
            <p>You wake up on a Tuesday morning.</p>
            <p>No alarm. No deadlines. No commute.</p>
            <p>You pour a cup of coffee, check your calendar, and realize… You don't have to worry about how the markets are doing today.</p>
            ...
            <p className="text-xl font-semibold">And that… is priceless.</p>
            
            <h3 className="text-2xl font-bold text-[#36596A] mt-8 mb-4">🎯 This Isn't About Getting Rich.</h3>
      ...
      <section className="bg-[#FFFCEB] py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
            <div>
              <h3 className="text-xl font-bold text-[#36596A] mb-2">✅ The Retirement Income Blueprint™</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-[#36596A] mb-2">🎁 Bonus #1: The 7-Figure Retirement Toolkit</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-[#36596A] mb-2">🎁 Bonus #2: "The 5 Income Killers" Video Mini-Class</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-[#36596A] mb-2">🎁 Bonus #3: The Social Security Optimization Cheatsheet</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-[#36596A] mb-2">🧠 Bonus #4: "How to Fire Your Advisor (or Not)" Interview</h3>
            ...
            <div className="border-t-2 border-[#36596A] pt-6 mt-6">
      ...
      <section className="bg-[#F4F4F4] py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
            ...
            <p>And if you don't feel <strong>more confident</strong>, more prepared, and more in control of your retirement income than ever before…</p>
            ...
            <h3 className="text-2xl font-bold text-[#36596A] mt-8 mb-4">✅ You Have Everything to Gain — and Nothing to Lose.</h3>
      ...
      <section className="bg-[#FFF8F2] py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6">
            <Clock className="w-16 h-16 text-[#36596A] mx-auto mb-4" />
            <h2 className="text-3xl md:text-4xl font-bold text-[#36596A] mb-4">
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#36596A] mb-6">
            Are You Ready to Stop Guessing… and Start Retiring With Confidence?
          </h2>
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-4 mb-8">
            ...
            <h3 className="text-2xl font-bold text-[#36596A] mt-8 mb-4">👉 Here's What You'll Get Instant Access To:</h3>
          ...
          <div className="bg-gray-100 rounded-lg p-6 text-left max-w-2xl mx-auto">
            ...
            <p>Or… you could have a real plan, today.</p>
