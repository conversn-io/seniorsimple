...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (ghlResponse.ok) {
      ...
      // NOTE: LynqFlux delivery for reverse mortgage leads is deferred to
      // /api/leads/deliver-lynqflux — called from the results page AFTER
      // BatchData returns property data (propertyvalue, ltv, loanamount).
