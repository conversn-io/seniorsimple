 ...
 *
 * Numbered retirement listicle, no geo personalization. Ported 1:1 from the
 * source HTML.
 */
...
export default function AngleBBody({ headline, headerSrc, ctaHref }: AngleBodyProps) {
  return (
    <>
      ...
      <h2 className={styles.h2}>
        <span className={styles.num}>1.</span> Paying full price on everyday spending
      </h2>
      ...
      <div className={styles.pick}>
        <div className={styles.pickTag}>Editor&apos;s Pick · The one that covers most of this list</div>
      ...
      <h2 className={styles.h2}>
        <span className={styles.num}>2.</span> Subscriptions you forgot you had
      </h2>
      <p className={styles.p}>
      ...
      <h2 className={styles.h2}>
        <span className={styles.num}>3.</span> Overpaying on insurance out of loyalty
      </h2>
      <p className={styles.p}>
      ...
      <h2 className={styles.h2}>
        <span className={styles.num}>4.</span> Bank and card fees
      </h2>
      <p className={styles.p}>
        Monthly maintenance fees, out-of-network ATM charges, and annual fees on cards you
        barely use are small individually and steady in aggregate. Fee-free checking and a
        card that fits how you actually spend can quietly erase a line item you&apos;d
        stopped noticing years ago.
      </p>

      <h2 className={styles.h2}>
        <span className={styles.num}>5.</span> Brand-name groceries and prescriptions
      </h2>
      <p className={styles.p}>
      ...
      <h2 className={styles.h2}>
        <span className={styles.num}>6.</span> Dining out at the posted price
      </h2>
      <p className={styles.p}>
      ...
      <h2 className={styles.h2}>
        <span className={styles.num}>7.</span> Booking travel without member rates
      </h2>
      <p className={styles.p}>
      ...
      <h2 className={styles.h2}>
        <span className={styles.num}>8.</span> Utility and phone bills you&apos;ve never questioned
      </h2>
      <p className={styles.p}>
      ...
      <h2 className={styles.h2}>
        <span className={styles.num}>9.</span> Entertainment and outings at full cost
      </h2>
      <p className={styles.p}>
      ...
      <h2 className={styles.h2}>The theme behind all nine</h2>
      <p className={styles.p}>
