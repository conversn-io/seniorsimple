 ...
 * area" tokens in body. Composes from the v2 primitives — masthead and
 * disclosure footer come from LpPage; body renders LeadIn (H1 + byline),
 * lead paragraphs, hero, sections, Editor's Pick, section CTAs, and FAQ.
 */
    ...
    <>
      ...
      <Section number={1} title="Dining out — the category most people underuse">
        ...
        <p className={styles.p}>
          ...
          the moment you&apos;re handed the check — which is exactly why a single place to
          check beats trying to memorize which of a dozen restaurants offers what.
        </p>
      </Section>
      ...
      >
        <p className={styles.p}>
          Travel is the highest-dollar category on this list. Hotels, flights, cruises,
          and rental cars routinely carry member or age-based rates, and because the
          per-transaction amounts are large, a single well-timed booking can return more
          than a full year of what you&apos;d pay to access those rates in the first
          place. If there&apos;s a trip on the calendar — visiting family, a
          long-postponed vacation, even a weekend drive that needs a hotel — this is the
          first place worth checking before you book anything.
        </p>
      </Section>
      ...
      <Section number={3} title={<>Groceries &amp; everyday shopping</>}>
        <p className={styles.p}>
          ...
          pharmacy run rarely feels dramatic in the moment — a few dollars here, a
          percentage there — but it&apos;s attached to the purchases you make most often,
          so it compounds. Over a year, the ordinary cart is where a lot of retirees are
          surprised to find they&apos;ve left the most on the table, precisely because
          none of it felt big enough to notice.
        </p>
      </Section>
      ...
      >
        <p className={styles.p}>
          ...
          change, a per-gallon break at the pump — but auto and fuel spending is
          relentless and repeat, and steady is exactly what matters when you&apos;re
          managing a fixed income. This is the category people dismiss as too small to
          bother with, right up until they add up a year of it.
        </p>
        <p className={styles.p}>
      ...
      >
        <p className={styles.p}>
          ...
          Used that way, they take the sting out of the wellness spending that tends to
          get cut first when a budget gets tight — which is often exactly the spending
          that keeps people feeling good.
        </p>
      </Section>
      ...
      <Section title="How these discounts actually work">
        <p className={styles.p}>
          ...
          themselves — is the reason most people leave this money unclaimed, and it&apos;s
          the specific problem a single membership is built to solve.
        </p>
      </Section>
      ...
      <Section title="Is a paid membership actually worth it?">
        <p className={styles.p}>
          ...
          Whether that&apos;s a good deal comes down to one thing and one thing only: do
          you use it? People who build a two-second habit of checking it before they dine
          out, book a trip, or make a larger purchase tend to cover the cost quickly and
          then some. People who sign up and forget it exists get nothing for their money.
          It isn&apos;t a windfall and it isn&apos;t magic — it&apos;s a tool, and a tool
          only helps the person who picks it up.
        </p>
        <p className={styles.p}>
      ...
      <SectionCTA>See the Discounts →</SectionCTA>
    </>
  );
}
