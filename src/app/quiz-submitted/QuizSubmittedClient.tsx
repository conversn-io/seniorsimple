...
// Client-side version of the quiz-submitted page. Separated so the page wrapper
// can opt out of static optimization (dynamic = 'force-dynamic') while keeping
// client-side session/localStorage logic intact.
...
export default function QuizSubmittedClient() {
  ...
  // Always render the personalized component, even if quizAnswers is null (use defaults inside)
