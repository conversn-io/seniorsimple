...
const PRIMARY_QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    subtitle: 'Include all retirement accounts, investments, and savings',
    type: 'multiple-choice' as const,
    options: [
      '$1,000,000+',
      '$750,000 - $999,999',
...
const SECONDARY_QUIZ_QUESTIONS = [
  {
    ...
    subtitle: 'This helps us recommend age-appropriate strategies',
    type: 'multiple-choice' as const,
    options: [
      'Under 50',
      '50-59',
  ...
  {
    id: 'currentSavings',
    title: 'What is your current total savings?',
    subtitle: 'Include all savings, investments, and retirement accounts',
    type: 'multiple-choice' as const,
    options: [
      '$50,000 - $99,999',
      '$25,000 - $49,999',
  ...
  },
  {
    ...
    subtitle: 'This helps us recommend realistic savings strategies',
    type: 'multiple-choice' as const,
    options: [
      '$5,000+',
      '$3,000 - $4,999',
  ...
  {
    id: 'savingsGoals',
    title: 'What are your primary savings goals?',
