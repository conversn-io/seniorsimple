...
interface RothConversionStrategyGuideProps {
  article: Article;
}

export default function RothConversionStrategyGuide({ article }: RothConversionStrategyGuideProps) {
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <FullWidthCalculatorEmbed 
        ...
        description="Calculate the potential benefits of converting traditional IRA funds to Roth IRA and determine the optimal conversion strategy."
        theme="purple"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <ul className="space-y-2 text-blue-600">
              <li><a href="/content/tax-efficient-withdrawals-strategy-guide" className="hover:text-blue-800 underline">Tax-Efficient Withdrawals Calculator</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-blue-600">
              ...
              <li><a href="/content/estate-planning-essentials" className="hover:text-blue-800 underline">Estate Planning Essentials</a></li>
            </ul>
          </div>
        </div>
      </div>
