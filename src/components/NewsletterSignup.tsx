      ...
      <form onSubmit={handleNewsletterSignup} className="space-y-4">
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-3 pl-12 border border-white border-opacity-30 rounded-lg bg-white bg-opacity-90 backdrop-blur-sm focus:ring-2 focus:ring-white focus:border-transparent focus:outline-none placeholder-gray-500 text-[#36596A] transition-all duration-300"
            required
        ...
        <button
          type="submit"
          disabled={isSubmitting}
          className="w-full bg-white text-[#36596A] py-3 px-6 rounded-lg font-medium hover:bg-gray-100 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center gap-2"
        >
          {isSubmitting ? (
            <>
